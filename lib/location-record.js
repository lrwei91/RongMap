...
function buildLocationRecord(locationData, options = {}) {
  ...
  return {
    ...
    category: locationData.category !== undefined
      ? normalizeLocationCategory(locationData.category, { fallback: 'food' })
      : normalizeLocationCategory(existing.category, { fallback: 'food' }),
    ...
    sourceId: locationData.sourceId !== undefined
      ? normalizeOptionalText(locationData.sourceId, 80)
